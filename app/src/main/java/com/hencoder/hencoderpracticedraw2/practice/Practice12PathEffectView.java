...
public class Practice12PathEffectView extends View {
...

    {
        ...
        dashPath.close();
        effect1 = new CornerPathEffect(10f);
        effect2 = new DiscretePathEffect(10, 10);
        effect3 = new DashPathEffect(new float[]{10, 5}, 10);
        effect4 = new PathDashPathEffect(dashPath, 10, 10, PathDashPathEffect.Style.TRANSLATE);
        effect5 = new SumPathEffect(effect2, effect3);
        effect6 = new ComposePathEffect(effect3, effect2);
    }
